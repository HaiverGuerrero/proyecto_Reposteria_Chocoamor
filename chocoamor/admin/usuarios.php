...
$query = "SELECT id,email,nombre,idRol FROM usuarios;";
$res = mysqli_query($con, $query);
...
?>
    ...
    <!-- /.content -->
    <div class="mr-3">
            <a class="btn btn-secondary float-right" target="_blank" href="imprimirUsuarios.php" role="button">Imprimir usuarios <i class="fas fa-file-pdf"></i> </a>
        </div>
</div>