$(document).ready(function () {
        ...
        response.forEach(element => {
            ...
            $("#tablaCarrito tbody").append(
                ...
                <tr>
                    ...
                    <td><i class="fa fa-trash text-danger borrarProducto" data-id="${element['id']}" style="cursor: pointer;"></i> </td>
                </tr>
                `
            );
        });
    ...
    function llenaCarrito(response){
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                `
                <a href="catalogo.php?modulo=detalleproducto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                ${element['nombre']}
                                <span class="float-right text-sm " style="color: #ca2b63;"><i class="fas fa-eye"></i></span>
                            </h3>
        ...
        $("#listaCarrito").append(
            `
            <a href="catalogo.php?modulo=carrito" class="dropdown-item dropdown-footer" style="color: #ca2b63;">
                Ver carrito 
